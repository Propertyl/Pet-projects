const MessageEyes = ({seen}:{seen:boolean}) => {
  return (
      <i className="message-view-icon">
          <svg  className='eye' version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
          ...
          <span style={{display:!seen ? 'flex' : 'none'}} className='eye-stick'></span>
      </i>
  )
}


export default MessageEyes;