...
import { UserData,ChatStructure, SetDispatch } from "../../types/global"
...
export class ChatProcess {
 ...
 async getUserPhone() {
    const {phone}:UserData = await queryRequest(userApi,'getUserConvenientData',{url:'info'},this.dispatch) as UserData;
