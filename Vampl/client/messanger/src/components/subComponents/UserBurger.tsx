...
const EditMode = ({burgerInfo,mode,switchMode}:{burgerInfo:BurgerInfo,mode:boolean | null,switchMode:Dispatch<SetStateAction<boolean | null>>}) => {
  ...
  const updateUserData = async () => {
      await serv.put('/user/update-info',{
        name:newName,
      });
...
const UserBurger = () => {
  ...
  return (
    ...
    <div className="container" style={{flexDirection:'column'}}>
       { burgerInfo ? 
         <>
          {editMode && isOwn && <EditMode burgerInfo={burgerInfo} mode={editMode} switchMode={setEditMode}/>}
