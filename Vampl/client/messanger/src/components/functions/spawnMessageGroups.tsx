...
import { ChatStructure, UserData } from "../types/global";

const spawnGroups = (chatData:ChatStructure,userData:UserData,userName:string,room:string,setUnreadMessage:any,setGroups:Dispatch<SetStateAction<ReactElement[]>>,
...
dispatch:DispatchRedux
    ...
    const dateGroups = Object.entries(chatData);
